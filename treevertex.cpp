...
TreeVertex::TreeVertex(const ode_state_type & x0, bool usezerotraj, double t_h_max_upper, const InterpVector & xxedge, const InterpVector & uuedge, const constraints_struct & constraints, const NSxNS_type & QQ, const NIxNI_type & RR, const NSxNS_type & P1, const NSxNS_type & QQlqr, const NIxNI_type & RRlqr, const NSxNS_type & P1lqr, double t_h_bar, bool save_edge)
...
double TreeVertex::JJLinearSteer (const NSx1_type & xxsamp, double t_h)
{
  if (t_h > t_h_bar_)
    return kLARGENUM;
...
bool TreeVertex::Projection(const NSx1_type & xxsamp, double t_h)
{
